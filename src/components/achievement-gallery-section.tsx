...
export function AchievementGallerySection({ className = "" }: AchievementGallerySectionProps) {
  return (
    <section className={`relative w-full ${className}`}>
      {/* 顶部区域：激光流 + 文字内容并排 */}
      <div className="relative w-full flex flex-col lg:flex-row items-center lg:items-end">
        {/* 左侧：激光流区域 */}
        ...
        <motion.div
          ...
          className="relative w-full lg:w-1/2 flex flex-col justify-end px-6 sm:px-10 lg:px-14 py-8 lg:py-0 lg:pb-16"
        >
          {/* 小标签 */}
      ...
      <motion.div
        ...
        className="relative w-full -mt-[100px] sm:-mt-[140px] lg:-mt-[180px] z-10"
      >
        {/* 图片展示卡片 - 带紫色边框 */}
        <div
        ...
        >
          {/* 图片展示区域占位 */}
          <div className="w-full h-full min-h-[350px] sm:min-h-[420px] rounded-xl sm:rounded-2xl border-2 border-dashed border-purple-500/20 bg-purple-500/5 flex flex-col items-center justify-center gap-4 text-center p-6">
