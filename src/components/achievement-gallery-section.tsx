                          ...
                          images.map((img, index) => (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="p-2.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 hover:bg-red-500/20 hover:scale-105 transition-all"
                              >
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <>
      ...
      <section className={`relative w-full ${className}`}>
        ...
        <div className="relative w-full flex flex-col lg:flex-row items-stretch">
          {/* 左侧：激光流区域 - 移动端隐藏 */}
          <div className="relative w-full lg:w-1/2 h-[600px] sm:h-[750px] lg:h-[850px] hidden lg:block">
            <LaserFlow
              color="#cf9eff"
        ...
        <motion.div
          ...
          className="relative w-full -mt-0 sm:-mt-0 lg:-mt-[425px] z-10"
        >
          {/* 图片展示卡片 */}
          <div
