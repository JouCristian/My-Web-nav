        ...
        <div className={`flex items-center gap-4 px-6 py-4 rounded-2xl backdrop-blur-xl border ${
          ...
          <div className="flex flex-col">
            <span className={`text-[10px] font-mono uppercase tracking-[0.2em] ${
              toast.type === 'success' ? 'text-emerald-400/80' : toast.type === 'error' ? 'text-red-500/80' : 'text-blue-500/80'
            }`}>
        ...
        <button 
          ...
          className={`w-full py-4 rounded-2xl font-bold tracking-[0.2em] transition-all duration-500 mt-4 flex items-center justify-center gap-3 ${
            !hasChanged
              ...
              : "bg-white text-black hover:bg-emerald-500 hover:text-white active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.05)] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)]" 
          }`}
        >
          {isUploading ? (
            <>
