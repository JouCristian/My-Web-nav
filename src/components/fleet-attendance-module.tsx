              ...
              <div className="w-full max-w-md flex flex-col items-center gap-8 relative">
                {isManager ? (
                  <>
                          ...
                          {isTimePickerOpen && (
                            <>
                              ...
                              <motion.div 
                                ...
                                className="absolute top-[120%] left-1/2 -translate-x-1/2 z-[50] w-72"
                              >
                    ...
                    <button onClick={startRollCall} className="w-full py-5 rounded-2xl bg-amber-500/10 border border-amber-500/40 text-amber-400 font-bold tracking-[0.3em] text-lg hover:bg-amber-500 hover:text-black transition-all shadow-[0_0_30px_rgba(245,158,11,0.2)] active:scale-95 z-10">发起全舰集结指令</button>
                  </>
                ) : (
