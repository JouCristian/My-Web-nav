  ...
  return (
    <>
      ...
      <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-stretch mt-4">
        ...
        <div className="lg:col-span-2 rounded-[2rem] sm:rounded-[3rem] lg:rounded-[3.5rem] border border-amber-500/20 bg-[#06060a]/80 backdrop-blur-3xl p-5 sm:p-8 lg:p-10 shadow-2xl flex flex-col h-full relative group z-20">
