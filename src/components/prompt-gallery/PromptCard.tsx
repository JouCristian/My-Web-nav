  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-2 pt-5">
        ...
        <p className="mt-4 line-clamp-2 h-[3.9375rem] overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.035] px-4 py-3 text-xs leading-relaxed text-zinc-300">
          {item.promptSummary}
        </p>
