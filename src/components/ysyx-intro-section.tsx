      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
          ...
          <div className="flex-1 w-full max-w-xl lg:max-w-none">
            <MacWindowCard>
              {/* 占位内容，后续设计 */}
              <div className="flex flex-col items-center justify-center h-full min-h-[300px] sm:min-h-[360px] text-zinc-500">
...
function MacWindowCard({ children, className }: MacWindowCardProps) {
  return (
    <div 
      className={`
        ...
        shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8),0_0_0_1px_rgba(255,255,255,0.05)]
        ${className || ''}
      `}
    >
      {/* Mac 窗口顶栏 */}
